...
#define ADDR_VDPDR		0x0006	//Base Port Address For VDP Data Read (1B/R)
#define ADDR_VDPDW		0x0007	//Base Port Address For VDP Data Write (1B/R)
...
#define ADDR_CLIKSW		0xf3bd	//Key Press Click Switch 0:Off 1:On (1B/RW)
#define ADDR_CSRY		0xf3cd	//Current Cursor Y-Position (Row) (1B/RW)
...
#define COL_BLACK			1
#define COL_MEDIUM_GREEN	2
#define COL_LIGHT_GREEN		3
#define COL_DARK_BLUE		4
#define COL_MEDIUM_BLUE		5
#define COL_DARK_RED		6
#define COL_LIGHT_BLUE		7
#define COL_MEDIUM_RED		8
